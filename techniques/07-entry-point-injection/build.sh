...
echo "======================================"
echo "  Entry Point Injection 构建脚本"
echo "======================================"
...
echo ""
echo "[3/4] 编译 Entry Point Injection 主程序..."
gcc -o ${BUILD_DIR}/entry_point_injection.exe \
...
echo "======================================"
echo "输出文件："
echo "  ${BUILD_DIR}/entry_point_injection.exe"
echo "  ${BUILD_DIR}/payload.bin"
echo "  ${BUILD_DIR}/test_payload.exe"
echo ""
echo "运行示例："
echo "  # 使用预生成的 shellcode："
echo "  ${BUILD_DIR}/entry_point_injection.exe C:\\\\Windows\\\\System32\\\\notepad.exe ${BUILD_DIR}/payload.bin"
echo ""
echo "  # 或使用自定义 shellcode："
echo "  ${BUILD_DIR}/entry_point_injection.exe C:\\\\Windows\\\\System32\\\\calc.exe your_payload.bin"
echo "======================================"
